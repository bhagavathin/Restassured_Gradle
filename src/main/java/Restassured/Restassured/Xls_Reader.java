...
public class Xls_Reader {
	public static String filename = System.getProperty("user.dir")
			+ "\\src\\config\\testcases\\Automation_Run_Report.xlsx";
	public String path;
	...
	public boolean setCellData(String sheetName, String colName, int rowNum,
		...
		try {
			...
			fileOut = new FileOutputStream(path.trim());
	...
	// returns true if data is set successfully else false
	public boolean setCellData1(String sheetName, String colName, int rowNum,String data, String url) {
	...
	public boolean addHyperLink(String sheetName, String screenShotColName,
		...
		for (int i = 2; i <= getRowCount(sheetName); i++) {
			if (getCellData(sheetName, 0, i).equalsIgnoreCase(testCaseName)) {
				...
				setCellData1(sheetName, screenShotColName, i + index, message,
						url);
				break;
			}
		}
